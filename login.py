...
def login_and_launch(user_id):
    subprocess.Popen(['python', 'main.py', user_id])
...
def handle_login():
    ...
    if user_id:
        ...
        # Pass the user_id to main.py
        result = subprocess.run(["python", "main.py", str(user_id)])
...
def show_login():
    ...
    label_password.grid(row=1, column=2, padx=5, pady=5, sticky='e')
    entry_password.grid(row=1, column=3, padx=5, pady=5, sticky='w')
    button_login.grid(row=1, column=4, padx=20, pady=5, sticky='e')
    back_button.grid(row=1, column=5, padx=20, pady=5, sticky='e')
...
def show_register():
    ...
    label_password.grid(row=1, column=2, padx=5, pady=5, sticky='e')
    entry_password.grid(row=1, column=3, padx=5, pady=5, sticky='w')
    button_register.grid(row=1, column=4, padx=20, pady=5, sticky='e')
    back_button.grid(row=1, column=5, padx=20, pady=5, sticky='e')
